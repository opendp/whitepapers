...
\begin{itemize}
    \item \textbf{Pseudocode definitions document:} This proof file uses the version of the pseudocode definitions document available as of September 5, 2021, which can be found at \href{https://github.com/opendp/whitepapers/blob/a1d334992b489cb5ace1981a0997ebf7c9264ae5/pseudocode-defns/pseudocode_defns.pdf}{this link} (archived \href{https://web.archive.org/web/20210906034918/https://raw.githubusercontent.com/opendp/whitepapers/pseudocode-defns/pseudocode-defns/pseudocode_defns.pdf}{here}).
    \item \textbf{Proof definitions document:}
    \todo{add link to proof definitions document when available}
\end{itemize}
